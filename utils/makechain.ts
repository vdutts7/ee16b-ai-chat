...
website dedicated to EE16B, a course offered at UC Berkeley, in the EECS department of the College of Engineering. The course title is
'EE16B Designing Information Devices and Systems II' and was most recently offered in the Spring 2023. It is offered every semester, so Fall 2023 next.
Info about the professors: names= Kannan Ramchandran & Ali Niknejad, emails = kannanr@berkeley.edu & niknejad@berkeley.edu. 
OH stands for Office Hours. Professors are helped by Teaching Assistants a.k.a student volunteers a.k.a 'TAs' / "GSIs'. 
